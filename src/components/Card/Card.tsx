...
const Card = ({ min, max, name, img, onClose, id, country }: cardI) => {
  ...
  // let countryCode: countryCodeI = {
  //   "AF": { en: "(AFGHANISTAN)", es: "(AFGANISTAN)" },
  //   "AX": { en: "(ALAND ISLANDS)", es: "(ISLAS ALAND)" },
  //   "AL": { en: "(ALBANIA)", es: "(ALBANIA)" },
  //   "DZ": { en: "(ALGERIA)", es: "(ALGERIA)" },
  //   "AS": { en: "(AMERICAN SAMOA)", es: "(SAMOA AMERICANA)" },
  //   "AD": { en: "(ANDORRA)", es: "(ANDORRA)" },
  //   "AO": { en: "(ANGOLA)", es: "(ANGOLA)" },
  //   "AI": { en: "(ANGUILLA)", es: "(ANGUILA)" },
  //   "AQ": { en: "(ANTARCTICA)", es: "(ANTARTIDA)" },
  ...
  //   "BH": { en: "(BAHRAIN)", es: "(BAREIN)" },
  //   "BD": { en: "(BANGLADESH)", es: "(BANGLADES)" },
  //   "BB": { en: "(BARBADOS)", es: "(BARBADOS)" },
  //   "BY": { en: "(BELARUS)", es: "(BIELORRUSIA)" },
  //   "BE": { en: "(BELGIUM)", es: "(BELGICA)" },
  //   "BZ": { en: "(BELIZE)", es: "(BELICE)" },
  //   "BJ": { en: "(BENIN)", es: "(BENIN)" },
  //   "BM": { en: "(BERMUDA)", es: "(BERMUDA)" },
  //   "BT": { en: "(BHUTAN)", es: "(BUTAN)" },
  //   "BO": { en: "(BOLIVIA)", es: "(BOLIVIA)" },
  //   "BQ": { en: "(SINT EUSTATIUS AND SABA BONAIRE)", es: "(CARIBE NEERLANDÉS)" },
  //   "BA": { en: "(BOSNIA AND HERZEGOVINA)", es: "(BOSNIA AND HERZEGOVINA)" },
  ...
  //   "BN": { en: "(BRUNEI DARUSSALAM)", es: "(BRUNEI)" },
  //   "BG": { en: "(BULGARIA)", es: "(BULGARIA)" },
  //   "BF": { en: "(BURKINA FASO)", es: "(BURKINA FASO)" },
  //   "BI": { en: "(BURUNDI)", es: "(BURUNDI)" },
  //   "KH": { en: "(CAMBODIA)", es: "(CAMBODIA)" },
  //   "CM": { en: "(CAMEROON)", es: "(CAMERUN)" },
  //   "CA": { en: "(CANADA)", es: "(CANADA)" },
  //   "CV": { en: "(CAPE VERDE)", es: "(CABO VERDE)" },
  //   "KY": { en: "(CAYMAN ISLANDS)", es: "(ISLAS CAIMAN)" },
  ...
  //   "KM": { en: "(COMOROS)", es: "(COMOROS)" },
  //   "CD": { en: "(THE DEMOCRATIC REPUBLIC OF THE CONGO)", es: "(REPÚBLICA DEMOCRÁTICA DEL CONGO)" },
  //   "CG": { en: "(CONGO)", es: "(CONGO)" },
  //   "CK": { en: "(COOK ISLANDS)", es: "(COOK ISLANDS)" },
  ...
  //   "CZ": { en: "(CZECH REPUBLIC)", es: "(RECUPLICA CHECA)" },
  //   "DK": { en: "(DENMARK)", es: "(DINAMARCA)" },
  //   "DJ": { en: "(DJIBOUTI)", es: "(YIBUTI)" },
  //   "DM": { en: "(DOMINICA)", es: "(DOMINICA)" },
  //   "DO": { en: "(DOMINICAN REPUBLIC)", es: "(RECUPLICA DOMINICANA)" },
  ...
  //   "JP": { en: "(JAPAN)", es: "(JAPON)" },
  //   "JE": { en: "(JERSEY)", es: "(JERSEY)" },
  //   "JO": { en: "(JORDAN)", es: "(JORDAN)" },
  //   "KZ": { en: "(KAZAKHSTAN)", es: "(KAZAJISTÁN)" },
  //   "KE": { en: "(KENYA)", es: "(KENIA)" },
  //   "KI": { en: "(KIRIBATI)", es: "(KIRIBATI)" },
  //   "KP": { en: "(DEMOCRATIC PEOPLE'S REPUBLIC OF KOREA)", es: "(REPÚBLICA POPULAR DEMOCRÁTICA DE COREA)" },
  //   "KR": { en: "(REPUBLIC OF KOREA)", es: "(REPÚBLICA DE COREA (COREA DEL SUR))" },
  //   "KW": { en: "(KUWAIT)", es: "(KUWAIT)" },
  //   "KG": { en: "(KYRGYZSTAN)", es: "(KIRGUISTÁN)" },
  //   "LA": { en: "(LAO PEOPLE'S DEMOCRATIC REPUBLIC)", es: "(LAOS)" },
  //   "LV": { en: "(LATVIA)", es: "(LETONIA)" },
  //   "LB": { en: "(LEBANON)", es: "(LIBANO)" },
  //   "LS": { en: "(LESOTHO)", es: "(LESOTHO)" },
  //   "LR": { en: "(LIBERIA)", es: "(LIBERIA)" },
  //   "LY": { en: "(LIBYAN ARAB JAMAHIRIYA)", es: "(LIBIA)" },
  //   "LI": { en: "(LIECHTENSTEIN)", es: "(LIECHTENSTEIN)" },
  //   "LT": { en: "(LITHUANIA)", es: "(LITUANIA)" },
  //   "LU": { en: "(LUXEMBOURG)", es: "(LUXEMBURGO)" },
  //   "MO": { en: "(MACAO)", es: "(MACAO)" },
  //   "MK": { en: "(MACEDONIA, THE FORMER YUGOSLAV REPUBLIC OF)", es: "(MACEDONIA DEL NORTE)" },
  //   "MG": { en: "(MADAGASCAR)", es: "(MADAGASCAR)" },
  //   "MW": { en: "(MALAWI)", es: "(MALAWI)" },
  ...
  //   "MX": { en: "(MEXICO)", es: "(MEXICO)" },
  //   "FM": { en: "(MICRONESIA, FEDERATED STATES OF)", es: "(ESTADOS FEDERADOS DE MICRONESIA)" },
  //   "MD": { en: "(MOLDOVA, REPUBLIC OF)", es: "(MOLDOVA)" },
  //   "MC": { en: "(MONACO)", es: "(MONACO)" },
  ...
  //   "NL": { en: "(NETHERLANDS)", es: "(PAISES BAJOS)" },
  ...
  //   "QA": { en: "(QATAR)", es: "(QATAR)" },
  //   "RE": { en: "(RÉUNION)", es: "(REUNION)" },
  //   "RO": { en: "(ROMANIA)", es: "(RUMANIA)" },
  //   "RU": { en: "(RUSSIAN FEDERATION)", es: "(RUSIA)" },
  //   "RW": { en: "(RWANDA)", es: "(RWANDA)" },
  //   "BL": { en: "(SAINT BARTHÉLEMY)", es: "(SAN BARTOLOME)" },
  //   "SH": { en: "(SAINT HELENA)", es: "(ISLA SANTA ELENA)" },
  //   "KN": { en: "(SAINT KITTS AND NEVIS)", es: "(SAN CRISTOBAL Y NIEVES)" },
  //   "LC": { en: "(SAINT LUCIA)", es: "(SANTA LUCIA)" },
  //   "MF": { en: "(SAINT MARTIN (FRENCH PART))", es: "(SAN MARTIN)" },
  //   "PM": { en: "(SAINT PIERRE AND MIQUELON)", es: "(SAN PEDRO Y MIQUELON)" },
  ...
  //   "SG": { en: "(SINGAPORE)", es: "(SINGAPORE)" },
  //   "SX": { en: "(SINT MAARTEN (DUTCH PART))", es: "(SAN MARTIN (PAISES BAJOS))" },
  //   "SK": { en: "(SLOVAKIA)", es: "(ESLOVAQUIA)" },
  //   "SI": { en: "(SLOVENIA)", es: "(ESLOVENIA)" },
  //   "SB": { en: "(SOLOMON ISLANDS)", es: "(ISLAS SOLOMON)" },
  //   "SO": { en: "(SOMALIA)", es: "(SOMALIA)" },
  //   "ZA": { en: "(SOUTH AFRICA)", es: "(SUDAFRICA)" },
  //   "GS": { en: "(SOUTH GEORGIA AND THE SOUTH SANDWICH ISLANDS)", es: "(ISLAS GEORGIAS DEL SUR Y SANDWICH DEL SUR)" },
  //   "SS": { en: "(SOUTH SUDAN)", es: "(SUDAN DEL SUR)" },
  //   "ES": { en: "(SPAIN)", es: "(ESPAÑA)" },
  //   "LK": { en: "(SRI LANKA)", es: "(SRI LANKA)" },
  //   "SD": { en: "(SUDAN)", es: "(SUDAN)" },
  //   "SR": { en: "(SURINAME)", es: "(SURINAM)" },
  //   "SJ": { en: "(SVALBARD AND JAN MAYEN)", es: "(SVALBARD Y JAN MAYEN)" },
  //   "SZ": { en: "(SWAZILAND)", es: "(SUAZILANDIA)" },
  //   "SE": { en: "(SWEDEN)", es: "(SUECIA)" },
  //   "CH": { en: "(SWITZERLAND)", es: "(SUIZA)" },
  //   "SY": { en: "(SYRIAN ARAB REPUBLIC)", es: "(SIRIA)" },
  //   "TW": { en: "(PROVINCE OF CHINA TAIWAN)", es: "(TAIWAN)" },
  //   "TJ": { en: "(TAJIKISTAN)", es: "(TAYIKISTÁN)" },
  //   "TZ": { en: "(UNITED REPUBLIC OF TANZANIA)", es: "(TANZANIA)" },
  //   "TH": { en: "(THAILAND)", es: "(TAILANDIA)" },
  //   "TL": { en: "(TIMOR-LESTE)", es: "(TIMOR ORIENTAL)" },
  //   "TG": { en: "(TOGO)", es: "(TOGO)" },
  //   "TK": { en: "(TOKELAU)", es: "(TOKELAU)" },
  //   "TO": { en: "(TONGA)", es: "(TONGA)" },
  //   "TT": { en: "(TRINIDAD AND TOBAGO)", es: "(TRINIDAD AND TOBAGO)" },
  //   "TN": { en: "(TUNISIA)", es: "(TUNEZ)" },
  //   "TR": { en: "(TURKEY)", es: "(TURQUIA)" },
  //   "TM": { en: "(TURKMENISTAN)", es: "(TURKMENISTAN)" },
  ...
  //   "UM": { en: "(UNITED STATES MINOR OUTLYING ISLANDS)", es: "(ISLAS ULTRAMARINAS MENORES DE LOS ESTADOS UNIDOS)" },
  //   "US": { en: "(UNITED STATES)", es: "(ESTADOS UNIDOS)" },
  //   "UY": { en: "(URUGUAY)", es: "(URUGUAY)" },
  //   "UZ": { en: "(UZBEKISTAN)", es: "(UZBEKISTAN)" },
  //   "VU": { en: "(VANUATU)", es: "(VANUATU)" },
  //   "VE": { en: "(VENEZUELA)", es: "(VENEZUELA)" },
  //   "VN": { en: "(VIETNAM)", es: "(VIETNAM)" },
  //   "VG": { en: "(VIRGIN ISLANDS, BRITISH)", es: "(ISLAS VÍRGENES BRITÁNICAS)" },
  //   "VI": { en: "(VIRGIN ISLANDS, USA)", es: "(ISLAS VÍRGENES DE ESTADOS UNIDOS)" },
  //   "WF": { en: "(WALLIS AND FUTUNA)", es: "(WALLIS AND FUTUNA)" },
  ...
  return (
    <Box sx={s.background}>
      <Button sx={s.button} onClick={onClose}>X</Button>
